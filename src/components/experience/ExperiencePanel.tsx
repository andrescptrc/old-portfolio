      ...
      <div className="w-full">
        ...
        <div className="flex flex-col gap-8">
          <div className="border-l-4 border-l-zinc-800 px-4 py-2 relative">
            ...
            <h3 className="mb-6 text-accent text-sm">May, 2021 - Present</h3>
            <ul className="text-accent space-y-4 text-[15px]">
              <li className='before:content-["▹"] before:text-primary before:absolute before:left-0 before:top-0 pl-6 relative'>
